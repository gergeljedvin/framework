...
class BasePage(object):
    ...
    def wait_for_element_to_appear(self, by, locator):
        WebDriverWait(self.driver, 30).until(EC.visibility_of_element_located((by, locator)))
        self.wait_for(1.5)

    def wait_for_element_to_become_invisible(self, by, locator):
        WebDriverWait(self.driver, 10).until(EC.invisibility_of_element_located((by, locator)))
